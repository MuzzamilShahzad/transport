$(document).ready(function () {
    ...
    $("#btn-add-shift").on("click", function (e) {
        ...
        if (timings == "") {
            $("#timings").addClass("has-error");
            $("#timings").after("<span class='error text-danger'>This field is required.</span>");
            flag = false;
        }

        if (flag) {

            $("#btn-add-shift").addClass('disabled');
            $("#btn-add-shift").html('. . . . .');
            ...
            $.ajax({
                ...
                complete: function () {
                    ...
                    $("#btn-add-shift").removeClass('disabled');
                    $("#btn-add-shift").html('Submitted');
                    setTimeout(function () {
                        $(".alert").remove();
                    }, 4000);
                }
    ...
    $("#btn-update-shift").on("click", function (e) {
        ...
        if (flag) {
            ...
            $("#btn-update-shift").addClass('disabled');
            $("#btn-update-shift").html('. . . . .');
            ...
            $.ajax({
                ...
                complete: function () {
                    ...
                    $("form").prepend(message);
                    $("#btn-update-shift").removeClass('disabled');
                    $("#btn-update-shift").html('Updated');
                    setTimeout(function () {
                        $(".alert").remove();
                    }, 4000);
                }
