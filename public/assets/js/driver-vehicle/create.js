$(document).ready(function () {
    $("#btn-add-driver_vehicle").on("click", function (e) {
        ...
        if (flag) {
            ...
            $("#btn-add-driver_vehicle").addClass('disabled');
            $("#btn-add-driver_vehicle").html('. . . . .');
            ...
            $.ajax({
                ...
                complete: function () {
                    ...
                    $("#btn-add-driver_vehicle").removeClass('disabled');
                    $("#btn-add-driver_vehicle").html('Submit');
                    setTimeout(function () {
                        $(".alert").remove();
                    }, 4000);
                }
