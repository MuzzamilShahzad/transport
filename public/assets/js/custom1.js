$(function () {
	...
	$(document).on("click", '#myonoffswitch19', function () {
		if (this.checked) {
			...
			(document.getElementById("style").setAttribute("href", baseUrl + "/assets/plugins/bootstrap/css/bootstrap.min.css"));
			...
			("head link#style").attr("href", $(this));
			(document.getElementById("style").setAttribute("href", baseUrl + "/assets/plugins/bootstrap/css/bootstrap.rtl.min.css"));
		}
	});
	/* LTR version End */
