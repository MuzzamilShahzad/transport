        ...
        <div class="inner-body">
                                    ...
                                    <div class="card-item">
                                        ...
                                        <div class="card-item-body">
                                            <div class="card-item-stat">
                                                ...
                                                <small><b class="badge rounded-pill bg-danger fs-11">15%</b> <span
                                                        class="px-1">Decreased</span></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card custom-card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title tx-18"><label class="main-content-label tx-15">RECENT ORDERS</label>
                            </h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                            ...
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/1.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/2.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/4.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/6.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/7.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/9.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/10.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/11.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/3.jpg') }}">
                                                </span>
                                        ...
                                        <tr>
                                            <td class="font-weight-normal d-flex">
                                                <span class="main-img-user">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="{{ url('assets/img/users/5.jpg') }}">
                                                </span>
