...
<head>
	...
	<!-- Icons css-->
	<link href="{{ url('assets/web-fonts/icons.css') }}" rel="stylesheet" />
	<link href="{{ url('assets/web-fonts/font-awesome/font-awesome.min.css') }}" rel="stylesheet">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="main-header-center">
                    <div class="responsive-logo">
                        <a href="index.html"><img src="{{ url('assets/img/brand/logo.png') }}" class="mobile-logo"
                                alt="logo"></a>
                        <a href="index.html"><img src="{{ url('assets/img/brand/logo-light.png') }}"
                            ...
                            <div class="d-flex order-lg-2 ms-auto">
                                ...
                                <!-- <div class="dropdown main-header-notification flag-dropdown">
                                    <a class="nav-link icon text-center" data-bs-target="#country-selector"
                                        ...
                                        <img class="header-icons" alt=""
                                            src="{{ url('assets/img/flags/us_flag.jpg') }}">
                                    </a>
                                </div> -->
                                <!-- country flag -->
                                        ...
                                        <div class="main-notification-list">
                                            <div class="media new">
                                                <div class="main-img-user online">
                                                    <img alt="avatar" src="{{ url('assets/img/users/5.jpg') }}">
                                                </div>
                                            ...
                                            <div class="media">
                                                <div class="main-img-user">
                                                    <img alt="avatar" src="{{ url('assets/img/users/2.jpg') }}">
                                                </div>
                                                <div class="media-body">
                                                    <a href="notifications-list.html">
                                            ...
                                            <div class="media">
                                                <div class="main-img-user online">
                                                    <img alt="avatar" src="{{ url('assets/img/users/3.jpg') }}">
                                                </div>
                                                <div class="media-body">
                                                    <a href="notifications-list.html">
                                ...
                                <div class="dropdown d-flex main-profile-menu">
                                    <a class="d-flex" href="javascript:;">
                                        <span class="main-img-user">
                                            <img alt="avatar" src="{{ url('assets/img/users/admin.png') }}">
                                        </span>
                                    </a>
                                    <div class="dropdown-menu">
                                        <div class="header-navheading">
                                            <h6 class="main-notification-title">ABCD</h6>
                                        </div>
                                ...
                                <!-- <div class="dropdown d-flex header-settings">
                                    <a href="javascript:;" class="nav-link icon" data-bs-toggle="sidebar-right"
