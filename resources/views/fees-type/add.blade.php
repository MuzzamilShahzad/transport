...
@section('page_title', 'Add Fees Type')
                            ...
                            <div class="row row-sm">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('contractor.store') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="tx-semibold">Fees Code</label>
                                            <input class="form-control" type="text" name="fees_code" id="fees-code" placeholder="Enter Fees Code">
                                        </div>

                                        <div class="form-group">
                                            <label class="tx-semibold">Description</label>
                                            <textarea class="form-control" name="description" id="description" placeholder="Enter Description Here" rows="3"></textarea>
                                        </div>

                                        <button class="btn ripple btn-primary" id="btn-add-fees-type" type="submit">Save</button>
...
<!-- {{-- Own javascript --}} -->
<script src="{{ url('assets/js/fees/fees-type.js') }}"></script>
