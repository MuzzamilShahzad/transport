                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 mb-0">
                                        <div class="form-group">
                                            <label class="form-label tx-semibold">House / Apartment Number</label>
                                            <input type="text" class="form-control" name="permanent_house_no" id="permanent-house-no" value="{{$data['studentAddressDetail']->permanent_house_no}}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <div class="form-group">
                                            <label class="form-label tx-semibold">Block Number</label>
                                            <input type="text" class="form-control" name="permanent_block_no" id="permanent-block-no" value="{{$data['studentAddressDetail']->permanent_block_no}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4 mb-0">
                                        <div class="form-group">
                                            <label class="form-label tx-semibold">Building Name/Number (If ANY)</label>
                                            <input type="text" class="form-control" name="permanent_building_name_no"  id="permanent-building-name-no" value="{{$data['studentAddressDetail']->permanent_building_name_no}}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4 mb-0">
                                        <div class="form-group">
                                            <label class="form-label tx-semibold">City</label>
                                            <input type="text" class="form-control" name="permanent_city" id="permanent-city" value="{{$data['studentAddressDetail']->permanent_city}}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
