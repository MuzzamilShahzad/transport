...
@section('page_title', 'Add Fees Group')
                            ...
                            <div class="row row-sm">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('contractor.store') }}" method="post">
                                        ...
                                        <button class="btn ripple btn-primary" id="btn-add-fees-group" type="submit">Save</button>
...
<!-- {{-- Own javascript --}} -->
<script src="{{ url('assets/js/fees/fees-group.js') }}"></script>
