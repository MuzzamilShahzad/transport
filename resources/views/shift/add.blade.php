                                ...
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('shift.store') }}" method="post">
                                        <div class="form-group">
                                            ...
                                            <input name="timings" class="form-control" type="text" id="timings" placeholder="Enter Time">
                                        </div>
                                        <button type="submit" id="btn-add-shift" class="btn ripple btn-primary">Save</button>
